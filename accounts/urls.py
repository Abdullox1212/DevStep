...
from .views import login_view, main_view, update_coins, group_list, shop_view, buy_product, logout, history_view, direction_list, month_list, lesson_detail, lesson_list, submit_task, student_list, update_payment_status
